...
public class TerrainPreloadScreen extends Screen {
   ...
   private void drawPanel(GuiGraphics graphics) {
      ...
      graphics.drawString(this.font, this.openPanel == TerrainPreloadScreen.Panel.WORLD ? "World Settings" : "Pre-generation Settings", x + PANEL_PADDING, y + 8, 16777215);
      if (this.openPanel == TerrainPreloadScreen.Panel.PREGENERATION) {
         graphics.drawString(this.font, "Square chunks per side", x + PANEL_PADDING, y + 58, 12632256);
      } else {
         graphics.drawString(this.font, "World scale", x + PANEL_PADDING, y + 24, 12632256);
      }
   }
   ...
   private void drawProgress(GuiGraphics graphics) {
      ...
      graphics.drawString(this.font, this.fitText(progress.status(), boxWidth - 20), x + 10, y + 6, 16777215);
   ...
   private void drawStartConfirmation(GuiGraphics graphics) {
      ...
      graphics.drawCenteredString(this.font, "Confirm Terrain Preload", this.width / 2, y + 10, 16777215);
      int textX = x + 16;
      int textY = y + 32;
      graphics.drawString(this.font, this.area.summary(), textX, textY, 14737632);
      graphics.drawString(this.font, "World scale: " + formatScale(this.overrides.worldScale()), textX, textY + 14, 14737632);
      graphics.drawString(this.font, "Roads: " + onOff(this.overrides.enableRoads()), textX, textY + 28, 12632256);
      graphics.drawString(this.font, "Buildings: " + onOff(this.overrides.enableBuildings()), textX, textY + 42, 12632256);
      graphics.drawString(this.font, "Water: " + onOff(this.overrides.enableWater()), textX, textY + 56, 12632256);
      graphics.drawString(this.font, "Structures: " + onOff(this.overrides.addStructures()), textX, textY + 70, 12632256);
      graphics.drawString(this.font, "Caves: " + onOff(this.overrides.caveGeneration()) + "  Ores: " + onOff(this.overrides.oreDistribution()), textX, textY + 84, 12632256);
   }
   ...
   private void drawCancelConfirmation(GuiGraphics graphics) {
      ...
      graphics.drawCenteredString(this.font, "Cancel terrain preload?", this.width / 2, y + 12, 16777215);
      graphics.drawCenteredString(this.font, "Completed downloads will remain in the shared cache.", this.width / 2, y + 28, 12632256);
   }
